            ...
            <header className="event-header">
                <div className="header-info">
                    ...
                    <div className="event-meta" style={{marginTop: "2rem"}}>
                        ...
                        <div className="meta-item">
                            <span className="icon-location" /> {totalDistinctCityNames} {totalDistinctCityNames === 1 ? 'Stadt' : 'Städte'} | {totalDistinctVenueNames} {totalDistinctVenueNames === 1 ? 'Arena' : 'Arenen'} | {tourData.eventCount} {tourData.eventCount === 1 ? 'Event' : 'Events'}
                        </div>
                    </div>
                </div>
